...
#region issue #169
		...
		[Test]
		public void TestNoMembers_PackableUnpackableFail()
		{
			Assert.Throws<SerializationException>( () => GetSerializationContextWithAsyncEnabled( true ).GetSerializer<NoMembersPackableUnpackable>() );
		}
		...
		{
			Assert.Throws<SerializationException>( () => GetSerializationContextWithAsyncEnabled( true ).GetSerializer<NoMembersPackable>() );
		}
		...
		{
			Assert.Throws<SerializationException>( () => GetSerializationContextWithAsyncEnabled( true ).GetSerializer<NoMembersUnpackable>() );
		}
		...
		{
			Assert.Throws<SerializationException>( () => GetSerializationContextWithAsyncEnabled( true ).GetSerializer<NoMembers>() );
		}
